...
def get_res(inputs):
    print('new')
    print(inputs)
    url = "http://219.216.64.231:27033/option1_cclue"
    timeout = 60  # 超时设置
    ...
    print('option1_cclue_api llm_input:\n')
    llm_input = ''
...
class Option1CCLUEWorker(ApiModelWorker):
    DEFAULT_EMBED_MODEL = "text_embedding"

    def __init__(
            self,
            *,
            model_names: List[str] = ["option1-cclue-api"],
